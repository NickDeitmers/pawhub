  ...
  render() {
    ...
    return (
      <div className="body-wrapper space-pt--70 space-pb--120">
        <Breadcrumb pageTitle="عربة التسوق" prevUrl="/home" />
                ...
                <div className="row">
                  <div className="col-12">
                    <div className="title-wrap">
                      <h4 className="cart-bottom-title text-right">
                        استخدم كود القسيمة
                      </h4>
                    </div>
                    <div className="discount-code text-right">
              ...
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    ...
                    <h4 className="grand-total-title text-right">
