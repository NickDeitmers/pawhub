      ...
      <div className="body-wrapper space-pt--70 space-pb--120">
        ...
        <div className="product-content-description border-bottom--thick space-pt--25 space-pb--25">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <p className="space-mb--25 text-right">
                  {product.shortDescription}
                </p>
                <h4 className="space-mb--5 text-right">الشحن مجانا</h4>
                <p className="text-right">
                  لبنغلاديش من البائع عبر الصين. الشحن
                  <br /> طريقة عبر الإنترنت.
                </p>
              </div>
            </div>
          </div>
        ...
        {product.variation ? (
          <div className="product-color-picker border-bottom--thick space-pt--25 space-pb--25">
            <div className="container">
              <div className="row">
                <div className="col-12">
                  <h3 className="space-mb--20 text-right">اختيار اللون</h3>
                  <form>
        ...
        <div className="product-content-description space-pt--25 space-pb--25">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h4 className="space-mb--5 text-right">تخصيص</h4>
                <p className="text-right">{product.fullDescription}</p>
              </div>
            </div>
          </div>
        </div>
