...
const NewProduct = ({ products, wishlistItems, addToWishlist }) => {
  return (
        ...
        <div className="row">
          <div className="col-12">
            ...
            <h2 className="section-title space-mb--20">
              منتجات جديدة
              <Link to={process.env.PUBLIC_URL + "/shop"}>عرض الكل</Link>
            </h2>
            {/* featured products */}
                            ...
                            <div className="price">
                              {single.discount && single.discount > 0 ? (
                                <Fragment>
                                  ...
                                  <span className="main-price ml-1">{`$${single.price}`}</span>
                                </Fragment>
                              ) : (
