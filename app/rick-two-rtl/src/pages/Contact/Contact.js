    ...
    <div className="body-wrapper space-pb--120">
      <div className="contact-page-content">
        <div
          ...
          style={{
            backgroundImage: `url(${
              process.env.PUBLIC_URL + "/assets/img/contact.jpg"
            })`
          }}
        />
          ...
          <div className="row">
            <div className="col-12 text-right">
              <div className="contact-page-content__text space-mb--25">
                ...
                <p>
                  هناك العديد من الاختلافات في مقاطع لوريم إيبسوم المتاحة ، لكن
                  الغالبية عانت من التغيير.
                </p>
              </div>
              <div className="contact-page-content__text-block space-mb--25">
                <h4>عنوان</h4>
                <p>
                  935-1670 Neque. شارع <br />
                  سينتينيال ديلاوير 48432
                </p>
              </div>
              <div className="contact-page-content__text-block space-mb--25">
                <h4>هاتف</h4>
