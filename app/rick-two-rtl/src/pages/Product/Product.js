  ...
  render() {
    ...
    return (
      <div className="body-wrapper space-pb--120">
        ...
        <div className="product-content-description border-bottom--thick space-pt--25 space-pb--25 text-right">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <p className="space-mb--25">{product.shortDescription}</p>
                <h4 className="space-mb--5">الشحن مجانا</h4>
                <p>
                  لبنغلاديش من البائع عبر الصين. الشحن <br /> طريقة عبر الإنترنت
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="product-content-safety border-bottom--thick space-pt--15 space-pb--15 text-right">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h4>
        ...
        {product.variation ? (
          <div className="product-color-picker border-bottom--thick space-pt--25 space-pb--25 text-right">
            <div className="container">
              <div className="row">
                <div className="col-12">
                  <h3 className="space-mb--20">اختيار اللون</h3>
                  <form>
        ...
        {/* product content description */}
        <div className="product-content-description space-pt--25 space-pb--25 text-right">
          <div className="container">
            <div className="row">
              <div className="col-12">
                <h4 className="space-mb--5">تخصيص</h4>
        ...
        <div className="shop-product-button">
          ...
          {productStock && productStock > 0 ? (
            ...
            >
              {productCartQty >= productStock ? "الأسهم" : "أضف إلى السلة"}
            </button>
          ) : (
