  ...
  render() {
    ...
    return (
      <div className="body-wrapper space-pb--120">
        <Breadcrumb pageTitle="عربة التسوق" />
        {cartItems && cartItems.length >= 1 ? (
          <Fragment>
            ...
            <div className="discount-code-wrapper space-mt--20 text-right">
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <div className="title-wrap">
                      <h4 className="cart-bottom-title">استخدم كود القسيمة</h4>
                    </div>
                    <div className="discount-code">
                      <p>أدخل رمز القسيمة الخاصة بك إذا كان لديك واحد</p>
                      <form>
            ...
            <div className="grand-total space-mt--20 text-right">
              <div className="container">
                <div className="row">
                  <div className="col-12">
                    <div className="title-wrap">
                      <h4 className="cart-bottom-title">إجمالي سلة التسوق</h4>
                    </div>
                    <h5>
                      السعر الكلي <span>${cartTotalPrice.toFixed(2)}</span>
                    </h5>

                    <h4 className="grand-total-title">
                      المبلغ الإجمالي <span>${cartTotalPrice.toFixed(2)}</span>
                    </h4>
